                                                            ...
                                                            <td>
                                                                  <div class="dropdown">
                                                                        ...
                                                                        <ul class="dropdown-menu">
                                                                              ...
                                                                              <button type="button" class="btn w-100" data-bs-toggle="modal" data-bs-target="#terima{{$item->id}}">
                                                                                    <li><a class="dropdown-item text-dark d-flex gap-3" href="#"><i class="bi bi-check-lg"></i>Terima</a></li>
                                                                              </button>
                                                                              <button type="button" class="btn w-100" data-bs-toggle="modal" data-bs-target="#tolak{{$item->id}}">
