        ...
        <div class="row mt-5">
            <div class="col">
                <div class="d-flex gap-2">
                    ...
                    <a type="button"
                        class="link-underline link-underline-opacity-0 link-underline-opacity-100-hover link-offset-2 pt-2"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Edit {{ $data->nama_pekerjaan }}
                                    </h1>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            value="{{ $data->provinsi }} , {{ $data->kota_kabupaten }}">
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal2">Selanjutnya</button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="d-flex gap-3">
                                        <div>
                                            <img src="{{ asset('storage/photo-employe/' . $item->image) }}" width="70px"
                                                height="70px" class="rounded" alt="">
                                            <img src="../../img/bg_iu.jpg" width="70px" height="70px" class="rounded"
                                                alt="">
                                        </div>
                                        <div>
