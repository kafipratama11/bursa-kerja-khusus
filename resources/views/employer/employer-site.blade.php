...
<div class="container pt-5">
      <div class="row justify-content-center align-items-center" style="height: 400px">
            ...
            <div class="col-xl-6 col-md-6 col-sm-12 justify-content-center d-flex">
                  <div>
...
<div class="align-items-center d-flex py-5" style="background-color: #E1F7F5;">
      <div class="container">
...
<div class="pt-5 pb-5" style="background-color: #ffffff;">
      <div class="container">
            <div class="row justify-content-center">
                  <div class="col-xl-6 col-md-8 col-sm-12 d-flex justify-content-center">
                        <div style="background-image: linear-gradient(to bottom right, #0E46A3, #1E3D71); border-radius: 20px; width: 470px; height:450px;" class="p-3 px-5 py-5 shadow">
                              <form action="{{ route('employe-login')}}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                          <label for="exampleFormControlInput1" class="form-label text-light mt-4">Email address</label>
