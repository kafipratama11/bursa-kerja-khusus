...
<body style="" class="bg-body-tertiary">
                              ...
                              <div class="row">
                                    ...
                                    <div class="col-xl-8 col-md-9 col-sm-12">
                                          <div class="mb-3">
                                                ...
                                                <textarea class="form-control" name="deskripsi" rows="10" placeholder="Masukkan Job Desc"></textarea>
                                          </div>
                                          @error('deskripsi')
                                          <small>{{ $message }}</small>
                                          @enderror
                                          <div class="mb-3">
                                                ...
                                                <textarea class="form-control" name="requirement" rows="10" placeholder="Masukkan Job Desc"></textarea>
                                          </div>
                                          @error('requirement')
                                          <small>{{ $message }}</small>
                                          @enderror
