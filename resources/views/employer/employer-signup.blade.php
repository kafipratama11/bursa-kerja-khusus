                                    ...
                                    <div class="row">
                                          ...
                                          <div class="col-6">
                                                <div class="mb-3">
                                                      ...
                                                      <input type="text" name="industri" class="form-control" id="exampleFormControlInput1" placeholder="" maxlength="50" value="{{old('name')}}">
                                                </div>
                                                @error('industri')
                                                <small>{{ $message }}</small>
                                                @enderror
                                    ...
                                    <div class="row align-items-start">
                                          <div class="col-6">
                                                ...
                                                <div class="mb-3">
                                                      ...
                                                      <input maxlength="12" type="text" name="no_telp" class="form-control" id="inputPassword" maxlength="12" placeholder="">
                                                </div>
                                                @error('no_telp')
                                                <small>{{ $message }}</small>
                                                @enderror
                                    ...
                                    <div class="row">
                                          <div class="col-12">
                                                <div class="d-flex justify-content-center">
                                                      <button type="submit" class="btn btn-signup w-100 mb-2 fw-medium rounded-pill">Daftar</button>
                                                </div>
                        ...
                        <form action="{{ route('employe-register')}}" method="POST">
                              ...
                              <div class="card-body px-5 fw-medium row" style="font-size: 14px">
                                    ...
                                    <div class="col-xl-6 col-md-6 col-sm-12">
                                          ...
                                          <div class="mb-3">
                                                <label for="exampleFormControlInput1" class="form-label">Alamat</label>
                                                <input type="text" name="alamat" class="form-control" id="inputPassword" maxlength="100" placeholder="">
                                          </div>
                                          @error('alamat')
                                          <small>{{ $message }}</small>
                                          @enderror
